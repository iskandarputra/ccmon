    ...
    <header className="titlebar" onDoubleClick={() => window.ccmon?.toggleMaximize()}>
      ...
      <div className="tb-right">
        ...
        <button
          ...
          title={
            privacy
              ? 'Privacy mode ON — money figures hidden ($•••). Click or press ⌘P to reveal.'
              : 'Privacy mode OFF — click or press ⌘P to hide money figures ($•••)'
          }
        >
          {privacy ? (
            <svg
        ...
        <div className="tb-controls" onDoubleClick={(e) => e.stopPropagation()}>
          ...
          <button
            className="tb-btn"
            onClick={() => window.ccmon?.toggleMaximize()}
            aria-label="maximize"
          >
