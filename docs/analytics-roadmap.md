...
| Debt | Status | Notes |
|---|---|---|
| Tests | paid | 443 vitest cases over the pure services, renderer libs and the CLI. CI runs typecheck + tests on every push, `npm run parity` stays manual (needs npx + network). |
